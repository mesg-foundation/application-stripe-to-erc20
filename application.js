...
MESG.whenEvent({ serviceID: 'webhook' }, {
  serviceID: 'stripe',
  taskKey: 'charge',
  inputs: (event, { data }) => {
...
MESG.whenEvent({ serviceID: 'stripe', eventKey: 'charged' }, {
...
MESG.whenEvent({ serviceID: 'ethereum-erc20-ropsten', eventKey: 'transfer', filter: (event, data) => {
